...
import BanSvg from './ban.svg?react';
import BridgeCircleSvg from './bridge-circle.svg?react';
import BridgeSvg from './bridge-icon.svg?react';
...
export const Active = (props: SvgIconProps) => (
  <SvgIcon {...props} component={ActiveSvg} inheritViewBox />
);
...
export const Ban = (props: SvgIconProps) => (
  <SvgIcon {...props} component={BanSvg} inheritViewBox />
);
export const Bridge = (props: SvgIconProps) => (
  <SvgIcon {...props} component={BridgeSvg} inheritViewBox />
);
export const BridgeCircle = (props: SvgIconProps) => (
  <SvgIcon {...props} component={BridgeCircleSvg} inheritViewBox />
);
...
export const Loader = (props: SvgIconProps) => (
  <SvgIcon {...props} component={LoaderSvg} inheritViewBox />
);
...
export const Succeeded = (props: SvgIconProps) => (
  <SvgIcon {...props} component={SucceededSvg} inheritViewBox />
);
