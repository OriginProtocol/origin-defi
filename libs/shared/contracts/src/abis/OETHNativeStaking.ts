export const OETHNativeStakingABI = [
  {
    inputs: [
      {
        components: [
      ...
      { internalType: 'address', name: '_ssvToken', type: 'address' },
      { internalType: 'address', name: '_ssvNetwork', type: 'address' },
      { internalType: 'uint256', name: '_maxValidators', type: 'uint256' },
      { internalType: 'address', name: '_feeAccumulator', type: 'address' },
      {
  ...
  {
    inputs: [],
    name: 'MIN_FIX_ACCOUNTING_CADENCE',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'ssvAmount', type: 'uint256' },
      {
        components: [
  ...
  },
  {
    inputs: [],
    name: 'doAccounting',
    outputs: [{ internalType: 'bool', name: 'accountingValid', type: 'bool' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  {
    inputs: [],
    name: 'lastFixAccountingBlockNumber',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'int256', name: '_validatorsDelta', type: 'int256' },
      {
        internalType: 'int256',
        name: '_consensusRewardsDelta',
        type: 'int256',
      },
      { internalType: 'uint256', name: '_ethToVaultAmount', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_fuseIntervalStart', type: 'uint256' },
      { internalType: 'uint256', name: '_fuseIntervalEnd', type: 'uint256' },
    ],
