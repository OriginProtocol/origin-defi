...
export const OETHVaultAdminABI = [
  ...
  {
    inputs: [{ internalType: 'uint16', name: '_basis', type: 'uint16' }],
  ...
  {
    inputs: [
      { internalType: 'address', name: '_swapperAddr', type: 'address' },
    ],
    name: 'setSwapper',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [],
    name: 'swapper',
    outputs: [{ internalType: 'address', name: 'swapper_', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
