...
export const AaveStrategyProxyABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_incentivesAddress', type: 'address' },
      { internalType: 'address', name: '_stkAaveAddress', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'stkAave',
    outputs: [
      { internalType: 'contract IAaveStakedToken', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
