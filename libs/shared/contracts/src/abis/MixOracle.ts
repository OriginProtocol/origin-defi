...
export const MixOracleABI = [
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'uint256', name: '_minDrift', type: 'uint256' },
      { internalType: 'uint256', name: '_maxDrift', type: 'uint256' },
    ],
    name: 'setMinMaxDrift',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: 'address[]', name: 'ethOracles', type: 'address[]' },
      { internalType: 'address[]', name: 'usdOracles', type: 'address[]' },
    ],
