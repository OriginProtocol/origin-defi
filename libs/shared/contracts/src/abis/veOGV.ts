export const veOGVABI = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'minStakeDuration_', type: 'uint256' },
  ...
  { inputs: [], name: 'NoLockupsToUnstake', type: 'error' },
  { inputs: [], name: 'NotMigrator', type: 'error' },
  { inputs: [], name: 'StakingDisabled', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    name: 'collectRewards',
    outputs: [
      { internalType: 'uint256', name: 'rewardCollected', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'rewardsSource',
    outputs: [
      { internalType: 'contract RewardsSource', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'unstake',
    outputs: [
      { internalType: 'uint256', name: 'unstakedAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'rewardCollected', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint256[]', name: 'lockupIds', type: 'uint256[]' },
    ],
    name: 'unstake',
    outputs: [
      { internalType: 'uint256', name: 'unstakedAmount', type: 'uint256' },
