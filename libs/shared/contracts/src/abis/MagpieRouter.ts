export const magpieRouterABI = [
  { inputs: [], name: 'ApprovalFailed', type: 'error' },
  { inputs: [], name: 'FailedUnwrap', type: 'error' },
  { inputs: [], name: 'FailedWrap', type: 'error' },
  { inputs: [], name: 'InsufficientAmountOut', type: 'error' },
  { inputs: [], name: 'InvalidAmountIn', type: 'error' },
  ...
  { inputs: [], name: 'UniswapV3InvalidAmount', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
