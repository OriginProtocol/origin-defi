...
export const SingleAssetStakingABI = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'user', type: 'address' },
      { indexed: false, internalType: 'bool', name: 'yes', type: 'bool' },
    ],
    name: 'Paused',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint8', name: 'stakeType', type: 'uint8' },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'duration', type: 'uint256' },
          { internalType: 'uint240', name: 'rate', type: 'uint240' },
  ...
  {
    inputs: [
      { internalType: 'uint8', name: '_stakeType', type: 'uint8' },
      { internalType: 'bytes32', name: '_rootHash', type: 'bytes32' },
      { internalType: 'uint256', name: '_proofDepth', type: 'uint256' },
    ],
    name: 'setAirDropRoot',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'address', name: '_frmAccount', type: 'address' },
      { internalType: 'address', name: '_dstAccount', type: 'address' },
