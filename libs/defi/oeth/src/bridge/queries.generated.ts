...
export type BridgeTransferStatesQueryVariables = Types.Exact<{
  messageIds?: Types.InputMaybe<
    Array<Types.Scalars['String']['input']> | Types.Scalars['String']['input']
  >;
}>;

export type BridgeTransferStatesQuery = {
  __typename?: 'Query';
  bridgeTransferStates: Array<{
...
>(
  ...
  options?: Omit<
    UseQueryOptions<BridgeTransfersQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<BridgeTransfersQuery, TError, TData>['queryKey'];
  },
) => {
  return useQuery<BridgeTransfersQuery, TError, TData>({
    queryKey: ['BridgeTransfers', variables],
    queryFn: graphqlClient<BridgeTransfersQuery, BridgeTransfersQueryVariables>(
      BridgeTransfersDocument,
      variables,
    ),
    ...options,
  });
...
useBridgeTransfersQuery.getKey = (variables: BridgeTransfersQueryVariables) => [
  'BridgeTransfers',
  variables,
];

useBridgeTransfersQuery.fetcher = (
  variables: BridgeTransfersQueryVariables,
  options?: RequestInit['headers'],
) =>
  graphqlClient<BridgeTransfersQuery, BridgeTransfersQueryVariables>(
    BridgeTransfersDocument,
    variables,
    options,
  );
...
>(
  ...
  options?: Omit<
    UseQueryOptions<BridgeTransferStatesQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
      BridgeTransferStatesQuery,
      TError,
      TData
    >['queryKey'];
  },
  ...
  return useQuery<BridgeTransferStatesQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ['BridgeTransferStates']
        : ['BridgeTransferStates', variables],
    queryFn: graphqlClient<
      BridgeTransferStatesQuery,
      BridgeTransferStatesQueryVariables
    >(BridgeTransferStatesDocument, variables),
    ...options,
  });
};

useBridgeTransferStatesQuery.getKey = (
  variables?: BridgeTransferStatesQueryVariables,
) =>
  variables === undefined
    ? ['BridgeTransferStates']
...
useBridgeTransferStatesQuery.fetcher = (
  variables?: BridgeTransferStatesQueryVariables,
  options?: RequestInit['headers'],
) =>
  graphqlClient<BridgeTransferStatesQuery, BridgeTransferStatesQueryVariables>(
    BridgeTransferStatesDocument,
    variables,
    options,
  );
