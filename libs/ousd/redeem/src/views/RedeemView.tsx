...
function RedeemViewWrapped() {
  ...
  const { data: balOusd, isLoading: isBalOusdLoading } = useBalance({
    address,
        ...
        <Card>
          ...
          <CardContent>
            <TokenInput
              ...
              balance={balOusd?.value}
              isBalanceLoading={isBalOusdLoading}
              token={tokens.mainnet.OUSD}
              isTokenClickDisabled
              tokenPriceUsd={prices?.OUSD}
